...
- `powershell -ExecutionPolicy Bypass -File scripts/run-local-backend-tests.ps1 -SupabaseUrl http://127.0.0.1:54321`: lulus `40/40`.
...
Tes minimal lokal dilakukan terhadap Supabase lokal `http://127.0.0.1:54321`:
