...
```bash
rg -n "wqnyoesvwnqfjqsbzmsi|tzgdnhjbsuokljvsbzke|supabase\\.co|sb_publishable|mock_santri_session|service[_-]?role|SERVICE_ROLE" src lib public index.html docs .env.example -g "!*.backup" -g "!*.dump"
```
