...
- memastikan target hanya local: `http://127.0.0.1:54321`, `localhost`, atau `::1`;
...
```text
powershell -ExecutionPolicy Bypass -File scripts/run-local-backend-tests.ps1 -SupabaseUrl http://127.0.0.1:54321
```
