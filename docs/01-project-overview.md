...
Proyek ini adalah export website Horizon AI untuk LPQ Al-Muhajirun yang akan dijadikan dasar pembangunan website baru **LPQ Al-Muhajirun 2**. Frontend memakai React + Vite dan berkomunikasi langsung dengan Supabase lama melalui client di `src/lib/customSupabaseClient.js`.
