...
### What went wrong:
1. When the user `admin@lpqalfathmaulana.id` signs in, their JSON Web Token (JWT) provided by Supabase often lacks the `"role": "admin"` claim inside `user_metadata`.
