...
const ParentingPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Parenting Islami - LPQ Al-Muhajirun</title>
        <meta name="description" content="Artikel dan tips parenting Islami untuk orang tua Muslim. Dukung peran Anda sebagai pendidik utama di rumah bersama LPQ Al-Muhajirun." />
        <meta property="og:title" content="Parenting Islami - LPQ Al-Muhajirun" />
