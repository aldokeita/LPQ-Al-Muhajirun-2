...
const FacilityImage = ({ src, alt, className, style }) => {
  ...
  return (
    <img
      src={src}
      alt={alt || 'Fasilitas LPQ Al-Muhajirun'}
      className={className}
      style={style}
      loading="lazy"
  ...
  <div className="fp-page">
    ...
    <div className="fp-empty">
      ...
      <p className="fp-empty__desc">
        Informasi fasilitas LPQ Al-Muhajirun akan muncul di sini setelah ditambahkan oleh admin.
      </p>
    </div>
  </div>
);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Lingkungan belajar yang nyaman, aman, dan mendukung — lihat fasilitas lengkap LPQ Al-Muhajirun Metode Qiroati Baturaja."
        />
        <link rel="canonical" href="https://lpqalmuhajirun.id/fasilitas" />
      </Helmet>
        ...
        <section className="fp-hero" aria-labelledby="fp-hero-title">
          ...
          >
            ...
            <p className="fp-hero__desc">
              Setiap ruang dan fasilitas di LPQ Al-Muhajirun dirancang untuk menciptakan suasana
        ...
        <div className="fp-container">
          ...
          <section className="fp-ambient" aria-labelledby="fp-ambient-title">
            ...
            >
              ...
              <p className="fp-section-header__desc">
                Lebih dari sekadar bangunan — LPQ Al-Muhajirun menghadirkan lingkungan yang
          ...
          <section className="fp-cta" aria-labelledby="fp-cta-title">
            ...
            >
              ...
              <p className="fp-cta__desc">
                Kunjungi LPQ Al-Muhajirun dan rasakan langsung lingkungan belajar yang nyaman
