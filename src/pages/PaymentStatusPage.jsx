...
const PaymentStatusPage = () => {
  ...
  useEffect(() => {
    if (paymentData) {
        const qrCodeVerificationUrl = `https://lpqalmuhajirun.id/verify/${paymentData.id}`;
                  ...
                  <div className="flex justify-between items-center">
                      ...
                      <div className="text-center flex-1 px-4">
                          ...
                          <p className="text-xs text-slate-500 mt-1 max-w-sm mx-auto leading-relaxed">
                              Jl. R. Suprapto No. 195 Kel. Kemalaraja Baturaja Timur<br/>
                              Telp: 0856-0902-5238 | lpqalmuhajirun.id
                          </p>
                      </div>
              ...
              <div className="p-10 space-y-8">
                  ...
                  <div className="pt-8 flex justify-between items-end">
                      ...
                      <div className="text-center">
                          <p className="text-sm text-slate-800 mb-16">Baturaja, {new Date().toLocaleDateString('id-ID', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
