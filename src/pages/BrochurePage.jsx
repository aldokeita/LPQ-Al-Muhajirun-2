  ...
  return (
    <div className="public-brochure-page">
      <Helmet>
        ...
        <meta name="description" content="Unduh brosur pendaftaran resmi dan materi pustaka dari LPQ Al-Muhajirun. Galeri publikasi dan informasi lembaga." />
      </Helmet>
        ...
        <div className="bros-container bros-hero__inner">
          <motion.div variants={heroVariants} initial="hidden" animate="visible">
            ...
            <p className="bros-hero__lead">
              Jelajahi materi pendaftaran, panduan program, dan pustaka digital dari LPQ Al-Muhajirun. Unduh dan bagikan kepada wali santri.
            </p>
          </motion.div>
