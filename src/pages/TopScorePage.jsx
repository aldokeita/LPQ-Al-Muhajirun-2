...
const TopScorePage = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 md:p-12 relative overflow-hidden font-sans text-slate-900 dark:text-slate-100">
            <Helmet>
                <title>Papan Skor Santri Terbaik - LPQ Al-Muhajirun Metode Qiroati Baturaja</title>
                <meta name="description" content="Leaderboard Top 10 Santri dengan poin tertinggi di LPQ Al-Muhajirun Metode Qiroati Baturaja." />
            </Helmet>
