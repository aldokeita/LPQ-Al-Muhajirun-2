          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-4">
              <div className="relative">
                ...
                <input id="username" type="text" placeholder="Email Guru/Admin atau Nomor Induk Qiroati" value={username} onChange={e => setUsername(e.target.value)} disabled={isSubmitting} className="w-full pl-12 pr-4 py-3 rounded-lg border bg-background text-foreground focus:ring-2 focus:ring-primary outline-none transition disabled:opacity-50" required />
              </div>
              <div className="relative">
